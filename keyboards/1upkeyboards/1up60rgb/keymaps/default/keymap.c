...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,   LT(1, KC_F), KC_G,    KC_H,  KC_J, KC_K, KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT,
    KC_LSFT, KC_LSFT, KC_Z,    KC_X,   KC_C,        KC_V,    KC_B,  KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT,
    KC_NO,   KC_LGUI, KC_LALT,                      KC_SPC,                              KC_RALT, KC_RGUI, MO(2),   KC_RCTL),
  ...
  LAYOUT_all(
    ...
    KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
