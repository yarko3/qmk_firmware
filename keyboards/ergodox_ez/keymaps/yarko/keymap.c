 ...
 *
 * ,---------------------------------------------------.           ,----------------------------------------------------.
 * | VIM_CMD |   1  |   2  |   3  |   4  |   5  |      |           |        |  6   |   7  |   8  |   9  |   0  |   Del  |
 * |---------+------+------+------+------+-------------|           |--------+------+------+------+------+------+--------|
 * |  Tab    |   q  |   w  |   e  |   r  |   t  |  (   |           |    )   |  y   |   u  |   i  |   o  |   p  |   \    |
 * |---------+------+------+------+------+------|      |           |        |------+------+------+------+------+--------|
 * |  Ctrl   |   a  |   s  |   d  |f/MDIA|   g  |------|           |--------|  h   |   j  |   k  |   l  |   ;  |   '"   |
 ...
 *                                `--------------------'           `----------------------'
 */
[VIM_INS] = LAYOUT_ergodox(
  // left hand
  TO(VIM_CMD), KC_1,  KC_2,  KC_3,    KC_4,           KC_5,    KC_NO,
  KC_TAB,      KC_Q,  KC_W,  KC_E,    KC_R,           KC_T,    KC_LPRN,
  KC_LCTL,     KC_A,  KC_S,  KC_D,    LT(MDIA, KC_F), KC_G,
  KC_LSFT,     KC_Z,  KC_X,  KC_C,    KC_V,           KC_B,    KC_LBRC,
  KC_NO,       KC_NO, KC_NO, KC_TILD, KC_GRV,
...
// Defines which layer is the Vim insert layer.
uint8_t vim_ins_layer(void) {
  return VIM_INS;
}
